# filename: unittest supports test discovery based on the name of test modules.
# the default pattern is test*.py (this can be set in vscode when configuring the test runner)

# class name starts with Test... best practice

# try using multiple assert statements to reduce boilderplate code

# verbosity to set how much information you want to see when running the tests
# verbosity=0: quiet
# verbosity=1: default
# verbosity=2: detailed

# you can add docstrings to make the output of python test_age.py easier to read
